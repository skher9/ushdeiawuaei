...
export default function TwoPointersHub() {
  ...
  return (
    <ModuleHubShell
      ...
      moduleDesc="8 games. Two ends meet in the middle. From two-sum to trapping rain water."
      tierLabel="TIER I · PATTERN 2"
      patternTag="TIER I · ARRAYS"
      accent="var(--cyan)"
      problems={TP_PROBLEMS.map(p => ({
        index: p.index,
        title: p.title,
      ...
      hrefBase="/learn/tier1/two-pointers"
      loading={loading}
    />
  );
}
