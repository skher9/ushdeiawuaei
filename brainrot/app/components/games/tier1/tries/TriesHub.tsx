...
export default function TriesHub() {
  ...
  return (
    <ModuleHubShell
      moduleTitle="Tries"
      moduleDesc="8 games. The prefix tree powering autocomplete, spell-check, and IP routing."
      tierLabel="TIER I · PATTERN 7"
      patternTag="TIER I · TRIES"
      accent="var(--cyan)"
      problems={TRIE_PROBLEMS.map(p => ({
        index: p.index,
        title: p.title,
