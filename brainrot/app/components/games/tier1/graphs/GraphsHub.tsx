...
export default function GraphsHub() {
  ...
  return (
    <ModuleHubShell
      ...
      moduleDesc="8 games. Flood fill, shortest path, island count. From Minesweeper to Tarjan bridges."
      tierLabel="TIER I · PATTERN 4"
      patternTag="TIER I · TRAVERSAL"
      accent="var(--cyan)"
      problems={GRAPH_PROBLEMS.map(p => ({
        index: p.index,
        title: p.title,
