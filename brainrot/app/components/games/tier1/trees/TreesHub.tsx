...
export default function TreesHub() {
  ...
  return (
    <ModuleHubShell
      moduleTitle="Trees & BST"
      moduleDesc="8 games. Insert, search, traverse, validate. The recursive structure that powers databases."
      tierLabel="TIER I · PATTERN 6"
      patternTag="TIER I · TREES"
      accent="var(--cyan)"
      problems={TREE_PROBLEMS.map(p => ({
        index: p.index,
        title: p.title,
