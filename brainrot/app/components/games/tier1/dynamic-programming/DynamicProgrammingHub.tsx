...
export default function DynamicProgrammingHub() {
  ...
  return (
    <ModuleHubShell
      ...
      moduleDesc="8 games. Fill the table, see the dependencies. From climbing stairs to longest palindromic subsequence."
      tierLabel="TIER II · PATTERN 8"
      patternTag="TIER II · OPTIMIZATION"
      accent="var(--cyan)"
      problems={DP_PROBLEMS.map(p => ({
        index: p.index,
        title: p.title,
      ...
      hrefBase="/learn/tier1/dynamic-programming"
      loading={loading}
    />
  );
}
