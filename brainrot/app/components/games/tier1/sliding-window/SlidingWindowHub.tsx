...
export default function SlidingWindowHub() {
  ...
  return (
    <ModuleHubShell
      ...
      moduleDesc="8 games. A frame that slides, expands, and contracts. From max average to min window substring."
      tierLabel="TIER I · PATTERN 3"
      patternTag="TIER I · ARRAYS"
      accent="var(--cyan)"
      problems={SW_PROBLEMS.map(p => ({
        index: p.index,
        title: p.title,
      ...
      hrefBase="/learn/tier1/sliding-window"
      loading={loading}
    />
  );
}
